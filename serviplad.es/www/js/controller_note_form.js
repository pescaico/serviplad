...
.controller('NuevaNotaCtrl', function($scope, $rootScope, DataService, facturaShared, $stateParams, $ionicPopup, $timeout, $http, $compile, $state, $localstorage) {
 ...
 $scope.setPastaTotal = function() {
        ...
        angular.element(document.getElementById('factura-IVA')).html(0 + "€");
...
$scope.pintaLinea = function(key) {
        ...
        var nombre = $scope.factura.materiales[key].nombre;
                        ...
                        var linea = nombre + ": " + cantidad + " hora" + plural + " a  " + precioUnidadSinIVA + " € . Total: " + (precioUnidadesSinIVA) + "€";
    ...
    $scope.showPopup = function() {
        ...
        var myPopup = $ionicPopup.show({
            ...
            templateUrl: 'templates/t_note_popup.html',
            title: 'Introduce las horas',
